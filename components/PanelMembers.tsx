...
export function PanelMembers() {
  ...
  return (
    <>
      <section className="w-full py-16 md:py-24 bg-background">
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">PANEL MEMBERS BY CLUSTER</h2>
          ...
          <div className="space-y-12">
            {clusters.map((cluster) => (
              <div key={cluster.id} className="rounded-2xl border border-border bg-white p-8 hover:shadow-lg transition-all duration-300">
                {/* Cluster Title */}
                <div className="mb-4">
      ...
      {/* Modal - Bigger with centered text */}
